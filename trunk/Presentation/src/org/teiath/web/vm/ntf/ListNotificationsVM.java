...
public class ListNotificationsVM
	...
	public void afterCompose(
		...
		if (ZKSession.getAttribute("myNotificationSearchCriteriaCriteria") != null) {
			notificationSearchCriteria = (NotificationSearchCriteria) ZKSession.getAttribute("myNotificationSearchCriteriaCriteria");
			ZKSession.removeAttribute("myNotificationSearchCriteriaCriteria");
	...
	public void onView() {
		...
		ZKSession.setAttribute("myNotificationSearchCriteriaCriteria", notificationSearchCriteria);
