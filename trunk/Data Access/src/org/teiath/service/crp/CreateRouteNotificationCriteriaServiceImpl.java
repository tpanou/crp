...
@Service("createRouteNotificationCriteriaService")
@Transactional
public class CreateRouteNotificationCriteriaServiceImpl
		implements CreateRouteNotificationCriteriaService {
